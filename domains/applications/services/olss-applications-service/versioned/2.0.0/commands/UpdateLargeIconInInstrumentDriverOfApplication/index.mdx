...
version: 1.0.0
name: UpdateLargeIconInInstrumentDriverOfApplication
summary: >-
  [NOT IMPLEMENTED] Creates or updates the large icon for the specified
  instrument driver.
...
## PUT `(/v1.0/applications/{appid}/drivers/{id}/largeicon)`
